...
class MKModel(BaseModel):
    ...
    def add_sitemodel(self, distribution, trait, traitname):
            ...
            # Sitemodel
            sitemodel = ET.SubElement(distribution, "siteModel", {"gammaCategoryCount":"1","id":"geoSiteModel.%s"%traitname,"spec":"SiteModel", "mutationRate":"1","shape":"1","proportionInvariant":"0"})
