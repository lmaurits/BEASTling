    ...
    def add_operators(self, run):
        ...
        for n, f in enumerate(self.features):
            ...
            if self.rate_variation:
                ...
                if self.relaxed:
                    ET.SubElement(run, "operator", {"id":"BSSVSoperator.c:%s"%fname,"spec":"BitFlipBSSVSOperator","indicator":"@rateIndicator.s:%s"%fname, "mu":"@ucldMean.c:%s" % self.name,"weight":"30.0"})
                else:
